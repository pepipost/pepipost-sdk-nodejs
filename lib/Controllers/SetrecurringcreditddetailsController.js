...
class SetrecurringcreditddetailsController {
    /**
     * Lets you configure a recurring credit allocation to a subaccount
     *
     * @param {UpdaterecurringCredisofsubaccount} body Update recurring credit account
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createSetrecurringcreditddetailsPOST(body, callback) {
        ...
        const _pathUrl = '/setrecurringcreditddetails';
...
module.exports = SetrecurringcreditddetailsController;
