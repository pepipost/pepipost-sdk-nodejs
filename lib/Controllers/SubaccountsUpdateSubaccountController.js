...
class SubaccountsUpdateSubaccountController {
    /**
     * lets you update credentials and credit type of a subaccount.
     *
     * @param {Updatesubaccount} body Update sub account
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createSubaccountsUpdateSubaccountPOST(body, callback) {
        ...
        const _pathUrl = '/subaccounts/updateSubaccount';
...
module.exports = SubaccountsUpdateSubaccountController;
