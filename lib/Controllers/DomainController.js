...
class DomainController {
    /**
     * This endpoint enables you to add a sending domain which is one of the pre-requisites for
     * sending emails.
     *
     * @param {DomainStruct} body Add new domain
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static adddomain(body, callback) {
