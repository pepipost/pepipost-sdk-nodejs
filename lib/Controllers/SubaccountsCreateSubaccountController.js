...
class SubaccountsCreateSubaccountController {
    /**
     * Subaccount is the same as any regular Pepipost account however the credits are managed by
     * the master account.
     *
     * @param {Createsubaccount} body create sub account
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createSubaccountsCreateSubaccountPOST(body, callback) {
        ...
        const _pathUrl = '/subaccounts/createSubaccount';
...
module.exports = SubaccountsCreateSubaccountController;
