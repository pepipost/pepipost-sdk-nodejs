...
class DomainDeleteController {
    /**
     * This endpoint allows you to delete a domain from your Pepipost account.
     *
     * @param {Deletedomain} body delete domain
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static deletedomain(body, callback) {
...
module.exports = DomainDeleteController;
