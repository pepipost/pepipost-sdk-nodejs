...
class SubaccountsSetsubaccountcreditController {
    /**
     * Lets you add(or remove) credits to a subaccount
     *
     * @param {UpdateCredisofsubaccount} body Update credit account
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createSubaccountsSetsubaccountcreditPOST(body, callback) {
        ...
        const _pathUrl = '/subaccounts/setsubaccountcredit';
...
module.exports = SubaccountsSetsubaccountcreditController;
