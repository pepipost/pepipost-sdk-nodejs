...
class DomainGetDomainsController {
    /**
     ...
     * @param {string} domain (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static getDomainStatusGET(status, domain, callback) {
        ...
        const _pathUrl = '/domain/getDomains';
...
module.exports = DomainGetDomainsController;
