...
class SubaccountsDeleteController {
    /**
     * Lets you delete a subaccount
     *
     * @param {Deletesubacoount} body delete subaccount
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static deleteSubaccountsDeleteDELETE(body, callback) {
        ...
        const _pathUrl = '/subaccounts/delete';
...
module.exports = SubaccountsDeleteController;
